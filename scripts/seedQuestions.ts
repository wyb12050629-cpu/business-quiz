...
const questionPool: Record<string, Record<Difficulty, QuestionItem[]>> = {
  노동법: {
    easy: [
      ...
      {
        category: "노동법",
        question: "수습 기간 중 최저임금의 90%만 지급할 수 있는 기간은?",
        options: ["1개월", "3개월", "6개월", "제한 없음"],
        answerIndex: 1,
        explanation:
          "근로기준법상 수습 기간 자체에 법적 상한은 없습니다. 다만 최저임금법에 따라 1년 이상 계약 시 수습 시작 3개월 이내에만 최저임금의 90%를 지급할 수 있으며, 4개월 차부터는 반드시 100% 이상을 지급해야 합니다.",
      },
      {
        category: "노동법",
      ...
      },
      {
        ...
        answerIndex: 2,
        explanation:
          "근로기준법 제60조에 따라 1년간 80% 이상 출근한 근로자에게는 정확히 15일의 유급휴가가 주어집니다. 3년 이상 근무 시 2년마다 1일씩 추가되어 최대 25일까지 늘어납니다.",
      },
      {
        category: "노동법",
    ...
    medium: [
      ...
      },
      {
        ...
        answerIndex: 1,
        explanation:
          "근로기준법 제56조 제2항에 따라 8시간 이내의 휴일근로는 통상임금의 50%를 가산합니다. 8시간을 초과하는 휴일근로분에 대해서는 100%를 가산합니다.",
      },
      {
        category: "노동법",
      ...
      },
      {
        ...
        answerIndex: 2,
        explanation:
          "5인 미만 사업장에는 근로기준법 전체가 적용되지 않는 것이 아니라, 일부 조항만 제외됩니다. 부당해고 구제신청(제23조)과 연장·야간·휴일 가산수당(제56조)은 적용되지 않지만, 최저임금·퇴직금·근로계약서 작성 의무는 그대로 적용됩니다.",
      },
      {
        category: "노동법",
        question:
  ...
  급여세금: {
    ...
    medium: [
      {
        category: "급여세금",
        question: "건강보험료율(2026년 기준)은 약 몇 %인가요?",
        options: ["3.545%", "5.09%", "7.19%", "9.0%"],
        answerIndex: 2,
        explanation:
          "2026년 건강보험료율은 7.19%이며, 직장가입자는 사용자와 근로자가 각각 50%씩 부담합니다. 장기요양보험료는 별도입니다.",
      },
      {
        category: "급여세금",
  ...
  복지혜택: {
    easy: [
      ...
      },
      {
        ...
        options: ["10일", "15일", "20일", "30일"],
        answerIndex: 2,
        explanation:
          "남녀고용평등법에 따라 배우자 출산휴가는 20일이며, 유급으로 보장됩니다. 출산일로부터 120일 이내에 사용해야 하며, 3회까지 나누어 사용할 수 있습니다.",
      },
    ],
    medium: [
      {
        category: "복지혜택",
        question: "2026년 기준 육아휴직 급여 상한액으로 맞는 것은?",
        options: [
          "월 150만원",
          "월 200만원",
          "기간별 차등 (최대 250만원)",
        ...
        answerIndex: 2,
        explanation:
          "고용보험법 시행령에 따라 육아휴직 급여 상한액은 기간별로 차등 적용됩니다. 1~3개월 최대 250만원, 4~6개월 최대 200만원, 7개월 이후 최대 160만원입니다.",
      },
      {
        category: "복지혜택",
    ...
    hard: [
      {
        category: "복지혜택",
        question:
          "6+6 부모육아휴직제에서 부모 모두 육아휴직 시 6개월 차의 급여 상한은?",
        options: [
          "각각 월 200만원",
          "각각 월 300만원",
          "각각 월 450만원",
        ...
        answerIndex: 2,
        explanation:
          "6+6 부모육아휴직제는 생후 18개월 이내 자녀에 대해 부모가 동시 또는 순차적으로 육아휴직 사용 시, 첫 6개월간 통상임금의 100%를 지급하며 6개월 차에는 각각 최대 450만원까지 지원합니다.",
      },
      {
        category: "복지혜택",
        question:
